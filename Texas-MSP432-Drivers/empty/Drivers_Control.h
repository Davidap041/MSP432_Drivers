...
extern void dr_I2C_Read(uint8_t n_I2C, uint8_t slaveAddr, uint8_t memAddr,uint8_t *data);
extern int dr_I2C_ReadRaw(uint8_t n_I2C, uint8_t slaveAddr, uint8_t memAddr, uint8_t byteCount, uint8_t *data);
extern void dr_I2C_Write(uint8_t n_I2C, uint8_t slaveAddr, uint8_t memAddr, uint8_t data);
